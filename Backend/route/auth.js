...
function generateToken(userId) {
  return jwt.sign({ id: userId }, JWT_SECRET, { expiresIn: '1h' });  // Adjust the secret and expiration time as needed
}
...
function hashPassword(password, salt = 'custom_salt') {
  return crypto
...
router.post('/login', async (req, res) => {
  ...
  try {
    ...
    // Rehash the plain-text password and compare with stored hash
